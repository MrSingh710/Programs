...
while traci.simulation.getMinExpectedNumber() > 0:
	...
	if k==1:
        ...
        #get coordinates
		position_x = str(traci.vehicle.getPosition(i)[0])
		position_y= str(traci.vehicle.getPosition(i)[1])
		position_z= str(traci.vehicle.getPosition3D(i)[2])
        #send to Netsim
		win32file.WriteFile(p1, position_x.encode())
		win32file.WriteFile(p1, position_y.encode())
		win32file.WriteFile(p1, position_z.encode())
		#time.sleep(0.5)
